...
static input string ___3______   = "------"; // --- MACD ---
       input int    Ind3Param0   =       24; // Fast EMA
       input int    Ind3Param1   =       27; // Slow EMA
       input int    Ind3Param2   =        9; // MACD SMA

static input string ___4______   = "------"; // --- RSI ---
       input int    Ind4Param0   =        8; // Period
...
static input string ___6______   = "------"; // --- Average True Range ---
       input int    Ind6Param0   =       20; // Period
       input double Ind6Param1   =   0.0009; // Level
static input string __Options___ = "------"; // --- Options ---
static input int    Magic_Number = 60551282; // Magic Number
...
void InitIndicators(void)
  {
   ...
   // Envelopes (Close, Simple, 30, 0.08)
   ...
   // Average True Range (20), Level: 0.0009
...
//+------------------------------------------------------------------+
/*STRATEGY MARKET FTMO-Data; AUDUSD; M15 */
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":1,"stopLoss":40,"takeProfit":80,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Entry Time","listIndexes":[0,0,0,0,0],"numValues":[1,0,23,0,0,0]},{"name":"Envelopes","listIndexes":[5,3,0,0,0],"numValues":[30,0.08,0,0,0,0]},{"name":"DeMarker","listIndexes":[2,0,0,0,0],"numValues":[25,0.45,0,0,0,0]},{"name":"MACD","listIndexes":[0,3,0,0,0],"numValues":[24,27,9,0,0,0]},{"name":"RSI","listIndexes":[2,3,0,0,0],"numValues":[8,50,0,0,0,0]},{"name":"RSI","listIndexes":[6,3,0,0,0],"numValues":[20,30,0,0,0,0]}],"closeFilters":[{"name":"Average True Range","listIndexes":[4,0,0,0,0],"numValues":[20,0.0009,0,0,0,0]}]} */
