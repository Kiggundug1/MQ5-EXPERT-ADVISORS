...
static input string ___1______   = "------"; // --- Envelopes ---
       ...
       input double Ind1Param1   =     0.10; // Deviation %
...
static input string ___3______   = "------"; // --- MACD ---
       input int    Ind3Param0   =       32; // Fast EMA
       input int    Ind3Param1   =       59; // Slow EMA
       input int    Ind3Param2   =        9; // MACD SMA

static input string ___4______   = "------"; // --- RSI ---
       input int    Ind4Param0   =       16; // Period
       input int    Ind4Param1   =       42; // Level
...
static input string ___6______   = "------"; // --- Average True Range ---
       input int    Ind6Param0   =       49; // Period
       input double Ind6Param1   =   0.0016; // Level
static input string __Options___ = "------"; // --- Options ---
static input int    Magic_Number = 60696850; // Magic Number
...
void InitIndicators(void)
  {
   ...
   // Average True Range (49), Level: 0.0016
...
//+------------------------------------------------------------------+
/*STRATEGY MARKET FTMO-Data; EURAUD; M15 */
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":1,"stopLoss":50,"takeProfit":90,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Entry Time","listIndexes":[0,0,0,0,0],"numValues":[1,0,23,0,0,0]},{"name":"Envelopes","listIndexes":[5,3,0,0,0],"numValues":[23,0.1,0,0,0,0]},{"name":"DeMarker","listIndexes":[2,0,0,0,0],"numValues":[48,0.46,0,0,0,0]},{"name":"MACD","listIndexes":[0,3,0,0,0],"numValues":[32,59,9,0,0,0]},{"name":"RSI","listIndexes":[2,3,0,0,0],"numValues":[16,42,0,0,0,0]},{"name":"RSI","listIndexes":[6,3,0,0,0],"numValues":[19,30,0,0,0,0]}],"closeFilters":[{"name":"Average True Range","listIndexes":[4,0,0,0,0],"numValues":[49,0.0016,0,0,0,0]}]} */
