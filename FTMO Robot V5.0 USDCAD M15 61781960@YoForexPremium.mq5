...
static input int    Magic_Number = 61781960; // Magic Number
...
void InitIndicators(void)
  {
   ...
   // Average True Range (20), Level: 0.0015
...
//+------------------------------------------------------------------+
/*STRATEGY MARKET FTMO-Data; USDCAD; M15 */
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":1,"stopLoss":50,"takeProfit":100,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Entry Time","listIndexes":[0,0,0,0,0],"numValues":[1,0,23,0,0,0]},{"name":"Envelopes","listIndexes":[5,3,0,0,0],"numValues":[15,0.07,0,0,0,0]},{"name":"DeMarker","listIndexes":[2,0,0,0,0],"numValues":[25,0.47,0,0,0,0]},{"name":"MACD","listIndexes":[0,3,0,0,0],"numValues":[32,36,9,0,0,0]},{"name":"RSI","listIndexes":[2,3,0,0,0],"numValues":[6,41,0,0,0,0]},{"name":"RSI","listIndexes":[6,3,0,0,0],"numValues":[19,30,0,0,0,0]}],"closeFilters":[{"name":"Average True Range","listIndexes":[4,0,0,0,0],"numValues":[20,0.0015,0,0,0,0]}]} */
