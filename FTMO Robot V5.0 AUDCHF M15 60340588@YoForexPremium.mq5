...
static input string ___6______   = "------"; // --- Average True Range ---
       input int    Ind6Param0   =       21; // Period
       input double Ind6Param1   =   0.0020; // Level
static input string __Options___ = "------"; // --- Options ---
static input int    Magic_Number = 60340588; // Magic Number
...
void InitIndicators(void)
  {
   ...
   // Average True Range (21), Level: 0.0020
...
//+------------------------------------------------------------------+
/*STRATEGY MARKET FTMO-Data; AUDCHF; M15 */
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":1,"stopLoss":30,"takeProfit":60,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Entry Time","listIndexes":[0,0,0,0,0],"numValues":[1,0,23,0,0,0]},{"name":"Envelopes","listIndexes":[5,3,0,0,0],"numValues":[31,0.11,0,0,0,0]},{"name":"DeMarker","listIndexes":[2,0,0,0,0],"numValues":[25,0.43,0,0,0,0]},{"name":"MACD","listIndexes":[0,3,0,0,0],"numValues":[9,20,9,0,0,0]},{"name":"RSI","listIndexes":[2,3,0,0,0],"numValues":[11,47,0,0,0,0]},{"name":"RSI","listIndexes":[6,3,0,0,0],"numValues":[19,30,0,0,0,0]}],"closeFilters":[{"name":"Average True Range","listIndexes":[4,0,0,0,0],"numValues":[21,0.002,0,0,0,0]}]} */
